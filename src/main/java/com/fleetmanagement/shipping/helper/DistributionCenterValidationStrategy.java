...
@Component
@Qualifier("DistributionCenterValidation")
public class DistributionCenterValidationStrategy implements DeliveryPointValidationStrategy {
	...
	@Autowired
	public DistributionCenterValidationStrategy(PackageService packageService, BagService bagService,
